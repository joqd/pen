...
from apps.seo.views.schema_builders_view import BreadcrumbSchemaBuilder, ProductSchemaBuilder

from ..models import Product, ProductImage, ProductSize, ProductVariant, SizeAttribute
